...
# 2. Séparation du jeu de données en train/val
N = len(trainset)
val_size = int(0.1 * N)
train_size = N - val_size

# random_split avec une graine fixe pour la reproductibilité
...
# Fin d'entraînement : force l'écriture des données sur le disque
writer.flush()
writer.close()
